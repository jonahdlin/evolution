...
export const CREATURE_WIDTH = 10;
export const CREATURE_HEIGHT = 10;
...
export const BOREDOM_FOOD_MIN = 10;
export const BOREDOM_FOOD_MAX = 200;

export const BOREDOM_MATE_MIN = 10;
export const BOREDOM_MATE_MAX = 200;
...
export const FOOD_MATE_PREFERENCE_MIN = 1;
export const FOOD_MATE_PREFERENCE_MAX = 90;

export const MATING_AGREEABLENESS_MIN = 1;
export const MATING_AGREEABLENESS_MAX = 90;
